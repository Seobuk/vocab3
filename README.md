...
- **영어 문장 공부 (v2.12)** — 졸업한 단어의 예문을 한글로 먼저 보여 주고, 탭하면 가려 둔 영어가 보이며 읽어 줘요. 위로 밀면 쉬움·아래로 밀면 어려움 — 어려운 문장일수록 가중치가 쌓여 더 자주 나오고, 멈출 때까지 계속 이어져요.
